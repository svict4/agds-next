...
export default {
	title: 'layout/Body',
	component: Body,
	// subcomponents: [BodyContainer],
} as ComponentMeta<typeof Body>;

const BodyExample: ComponentStory<typeof Body> = (args) => (
	<Body {...args}>
		...
		<p>
			...
			with 1 to 3 levels and, as we mentioned, to display the sub-navigation of
			a given page.
		</p>
		<p>
			Read more about how to best design and structure your web content using
			the{' '}
			<a
				target="_blank"
...
export const BodyLight = () => (
	<Box theme="light" padding={2}>
		<BodyExample />
	</Box>
);
BodyLight.parameters = {
	layout: 'fullwidth',
};

export const BodyDark = () => (
	<Box theme="dark" padding={2} background="page">
		<BodyExample />
	</Box>
);
BodyDark.parameters = {
